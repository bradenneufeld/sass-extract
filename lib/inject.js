...
function createInjection(fileId, categoryPrefix, declaration, idx, declarationResultHandler, sass) {
  ...
  var injectedFunction = function injectedFunction(inputSassValue) {
  ...
  return { fnName: fnName, fnSignature: fnSignature, injectedFunction: injectedFunction, injectedCode: injectedCode };
}
