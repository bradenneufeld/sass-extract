      ...
      load: function load(canonicalUrl) {
        ...
        try {
          ...
          try {
            ...
            try {
              for (var _iterator = includedFiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    load: function load(canonicalUrl) {
      ...
      try {
        ...
        try {
          ...
          try {
            for (var _iterator2 = includedFiles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
