...
function verifyInFnBlocks(rendered, sourceFile) {
  ...
  expect(rendered.vars.global.$mixin1.declarations).to.have.length(2);
  expect(rendered.vars.global.$mixin1.declarations[1].expression).to.equal(`'m-variable-1' !global`);
  ...
  expect(rendered.vars.global.$mixin2.declarations).to.have.length(2);
  expect(rendered.vars.global.$mixin2.declarations[1].expression).to.equal(`'m-variable-2' !global`);
  ...
  expect(rendered.vars.global.$mixin3.declarations).to.have.length(2);
  expect(rendered.vars.global.$mixin3.declarations[1].expression).to.equal(`$someDefault !global`);
  ...
  expect(rendered.vars.global.$function1.declarations).to.have.length(2);
  expect(rendered.vars.global.$function1.declarations[1].expression).to.equal(`'fn-variable-1' !global`);
  ...
  expect(rendered.vars.global.$function2.declarations).to.have.length(2);
  expect(rendered.vars.global.$function2.declarations[1].expression).to.equal(`'fn-variable-2' !global`);
  ...
  expect(rendered.vars.global.$function3.declarations).to.have.length(2);
  expect(rendered.vars.global.$function3.declarations[1].expression).to.equal(`$param7 !global`);
  ...
  expect(rendered.vars.global.$someGlobalSetOnInvoke1.declarations).to.have.length(2);
  expect(rendered.vars.global.$someGlobalSetOnInvoke1.declarations[1].expression).to.equal(`$param !global`);
  ...
  expect(rendered.vars.global.$someGlobalSetOnInvoke2.declarations).to.have.length(2);
  expect(rendered.vars.global.$someGlobalSetOnInvoke2.declarations[1].expression).to.equal(`$param !global`);
